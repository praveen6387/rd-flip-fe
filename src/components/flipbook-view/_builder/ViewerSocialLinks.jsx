...
const LINKS = [
  {
    ...
    label: "WhatsApp",
    Icon: WhatsAppIcon,
    className: "hover:border-emerald-300/50 hover:text-emerald-200",
  },
  {
    key: "instagram_url",
    platform: "instagram",
    label: "Instagram",
    Icon: InstagramIcon,
    className: "hover:border-fuchsia-300/50 hover:text-fuchsia-200",
  },
  {
    key: "facebook_url",
    platform: "facebook",
    label: "Facebook",
    Icon: FacebookIcon,
    className: "hover:border-sky-300/50 hover:text-sky-200",
  },
];
    ...
    <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
      {items.map(({ key, href, label, Icon, className }) => (
        <a
          ...
          aria-label={label}
          title={label}
          className={`grid size-7 place-items-center rounded-full border border-amber-200/25 bg-black/30 text-amber-100/75 transition sm:size-8 ${className}`}
        >
